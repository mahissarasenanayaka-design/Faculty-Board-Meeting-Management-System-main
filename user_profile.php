...
<?php echo showError($error); unset($_SESSION['not_match']); ?>
<?php echo showError2($error2); unset($_SESSION['incorrect_current']); ?>
<?php echo showSuccess($success); unset($_SESSION['password_changed']); ?>
<h3>Update User Details Form</h3>
      ...
      <form action="form.php" method="post">
        ...
        <button type="submit" name="change_user_password">Update Password</button>
      </form>
